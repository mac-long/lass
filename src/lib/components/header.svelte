...
<button class="absolute top-0 right-0 p-4 text-black dark:text-white hover:text-primary-light dark:hover:text-primary-dark" on:click={() => configVisibile.set(true)}>
