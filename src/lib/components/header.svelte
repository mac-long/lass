<script>
	import { configVisibile } from '$lib/store';
</script>

<div class="flex flex-col items-center mb-16 space-y-8 text-center">
	<svg
		class="w-32 h-32"
	...
	<h1 class="text-4xl font-bold">3 Sided Cube FC League</h1>
</div>

<button class="absolute top-0 right-0 p-4 text-black dark:text-white hover:text-primary-light dark:hover:text-primary-dark duration-300" on:click={() => configVisibile.set(true)} aria-label="New Fixture">
